  ...
  return (
    ...
    >
      <Reveal className="mx-auto max-w-3xl px-6 text-center md:px-12">
        <p className="text-xs font-extrabold uppercase tracking-[0.22em] text-metallic-gold">
        ...
        <Link
          ...
          className="mt-10 inline-flex min-h-[48px] w-full items-center justify-center gap-2 rounded-full bg-metallic-gold px-6 py-3 text-sm font-semibold text-[var(--color-on-primary)] transition-all hover:scale-[1.01] shadow-sm sm:w-auto"
        >
