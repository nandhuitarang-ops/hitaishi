      ...
      {active && showInfo && (
        <aside className="hidden md:flex flex-col border-l border-rule bg-surface-card overflow-y-auto">
          ...
          <div className="p-4 border-b border-rule">
            <div className="meta mb-2">STUDENT PROFILE</div>
          ...
          <div className="p-4">
            <div className="meta mb-2">QUICK ACTIONS</div>
            <div className="flex flex-col gap-2">
              <LinkButton href="/mentor/sessions" size="sm" variant="ghost">
                View all sessions
              </LinkButton>
              <LinkButton href="/mentor/doubts" size="sm" variant="ghost">
                Open doubt inbox
              </LinkButton>
            </div>
          </div>
