    ...
    <>
      ...
      {success ? (
        <div className="text-center py-6 space-y-3">
          ...
          <h3 className="font-semibold text-emerald-700">Password Set Successfully!</h3>
...
export default function ResetPasswordPage() {
  return (
    <main className="min-h-screen bg-surface text-ink relative flex flex-col justify-between overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-emerald-400/10 rounded-full blur-[100px] pointer-events-none -z-10" />
      ...
      <div className="relative z-10 max-w-md w-full mx-auto px-6 py-8 flex-grow flex items-center justify-center">
        <Card className="backdrop-blur-xl bg-white/80 border border-white/60 shadow-lift rounded-3xl relative overflow-hidden before:absolute before:inset-x-0 before:top-0 before:h-1.5 before:bg-gradient-to-r before:from-primary before:to-emerald-400 w-full">
