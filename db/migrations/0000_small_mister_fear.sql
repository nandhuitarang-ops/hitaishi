...
CREATE TYPE "public"."webhook_provider" AS ENUM('msg91', 'resend');--> statement-breakpoint
CREATE TYPE "public"."lead_type" AS ENUM('student-inquiry', 'mentor-application', 'institution-partner', 'general');--> statement-breakpoint
